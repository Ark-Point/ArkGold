...
export default function TradeCard() {
    ...
    return (
        <div className="relative w-[541px] h-[605px] rounded-[18px] p-[3px]">
            <div
                ...
                <div className="relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="flex bg-[#1A1A1A] p-1 rounded-xl mb-8 border border-[#2E2E2E]">
                        <button
                            ...
                            className={`px-8 py-2 rounded-lg font-inter font-medium text-sm transition-all ${activeTab === 'Buy' ? 'bg-[#2E2E2E] text-white' : 'text-[#8C8D91] hover:text-white'}`}
                        >
                            Buy
                        </button>
                        <button
                            onClick={() => { setActiveTab('Sell'); setPayAmount(''); setReceiveAmount(''); setActivePercent(null); }}
                            className={`px-8 py-2 rounded-lg font-inter font-medium text-sm transition-all ${activeTab === 'Sell' ? 'bg-[#2E2E2E] text-white' : 'text-[#8C8D91] hover:text-white'}`}
                        >
                            Sell
                        </button>
                    </div>
                    ...
                    <div className="mt-[42px] w-full flex flex-col items-center">
                        ...
                        <button
                            ...
                            className={`w-full h-[60px] rounded-xl font-inter font-semibold text-lg transition-all ${!payAmount || parseFloat(payAmount) <= 0
